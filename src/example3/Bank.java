...
import example3.exceptions.InvalidInput;
import example3.exceptions.TermCompleteException;
...
public class Bank {
	...
	private void menu(Account account) {
		while (true) {
			...
			} catch (InvalidInput | NumberFormatException | ExitException | TermCompleteException e) {
