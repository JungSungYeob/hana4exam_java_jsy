import company.ManagerService;
import company.PermanentWorker;
import company.SalesWorker;
import company.TemporaryWorker;
...
public class Main {
	public static void main(String[] args) {
		...
		manager.addWorker(new SalesWorker("코난", 3000000, 2500000, 0.1));
